...
<input type="text" id="positionSelect" disabled>
</div>
...
<input type="hidden" id="layoutIndex">
</div>

<div class="form-group">
<label for="passLabel">Name</label>
<input id="passLabel" type="text" required placeholder="Enter password name (15 characters max)" maxlength="15">
</div>
...
<button type="button" onclick="generatePass()" class="modern-btn" style="width: 50px; flex: 0 0 auto; padding: 0;"><div class="icon"><div class="icon-die"></div></div></button>
